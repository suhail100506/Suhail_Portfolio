            ...
            <div className="container">
                ...
                <div className="group/projects relative" ref={containerRef}>
                    {selectedProject !== null && (
                        <div
                            className={cn(
                                "max-md:hidden absolute right-0 top-0 z-[1] pointer-events-none overflow-hidden opacity-0",
                                selectedProject === 'credent-mobile-app'
                                    ? "w-[160px] xl:w-[260px] aspect-[9/20]"
                                    : "w-[200px] xl:w-[350px] aspect-[3/4]"
                            )}
                            ref={imageContainer}
                        >
